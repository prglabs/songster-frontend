...
const ShuffleCards = () => {
  ...
  const [order, setOrder] = useState(['front', 'middle', 'back', 'back']);
...
const Card = ({
  ...
  return (
    ...
    >
      <div className='text-left text-4xl font-bold uppercase tracking-tighter underline decoration-indigo-600'>
        {imgUrl}
      </div>
      <span className='text-md trackong-tighter text-left text-white'>
        {testimonial}
      </span>
