  ...
  return (
    <div className="bg-black">
      ...
      <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center p-8">
        ...
        <p className="tracking-tighter text-center text-7xl font-black uppercase text-white sm:text-8xl md:text-9xl tracking-tighest">
         Maestro 
        </p>
        <p className="text-3xl lowercase text-center text-white tracking-tighter md:text-3xl">
        ...
        <div className="flex flex-row space-x-3">
          <a target="_blank" href="https://www.getwaitlist.com/waitlist/12014">
            <button className=" rounded-full p-4 pointer-events-auto bg-sky-500 px-4 py-2 text-md tracking-tigher font text-white ">
              Join The Waitlist
            </button>
          </a> 
          <a href= "https://calendly.com/peregrine-labs/30min" target="_blank">
            <button className=" rounded-full p-4 pointer-events-auto bg-sky-500 px-4 py-2 tracking-tigher text-md text-white ">
              Schedule A Demo
            </button>
          </a>
        </div>
