...
const AccordionSolutions = () => {
  ...
  return (
    <section className=' bg-black text-white'>
      <div className=' mx-auto grid max-w-5xl grid-cols-1 gap-8 lg:grid-cols-[1fr_350px]'>
        <div>
        ...
        <div className='rounded-2xl bg-black text-5xl font-semibold tracking-tight text-white lg:aspect-auto'>
          We have unrelenting{' '}
          <span className='underline decoration-indigo-500'>passion</span> for
          startups
          <br></br>
          <br></br>
          <p className='text-base'>
            Peregrine Labs is on a mission to redefine the private market
            ecosystem. We are a team of technologists offering a truly
            differentiated operating model that{' '}
            <span className='underline decoration-indigo-500'>
              shatters the VC mold.
            </span>
          </p>
          <br></br>
          <div className='items-left justify-left flex bg-black'>
            <RoundedSlideButton />
          </div>
        </div>
      </div>
      ...
      >
        <div>
          <motion.p
            ...
            className='w-fit bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-xl font-bold tracking-tight'
          >
            {title}
          </motion.p>
          <div>
            <motion.p
              ...
              className='mt-4 bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-sm text-transparent'
            >
              {description}
            </motion.p>
          </div>
