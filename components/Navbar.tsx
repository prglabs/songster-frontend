...
import {faPhone, faContactBook, faContactCard, faHome } from '@fortawesome/free-solid-svg-icons'
import Image from "next/image";
const Navbar = () => {
  return (
    <header className="header sticky top-0 bg-black shadow-md flex flex-col md:flex-row items-center justify-between px-8 py-2 md:text-xs">
      {/* <!-- logo --> */}
      <h1 className="w-3/12">
        <a href=""></a>
      </h1>
      ...
      {/* <!-- navigation --> */}
      <nav className="fixed left-[50%] top-8 flex w-fit -translate-x-[50%] items-center gap-6 rounded-lg border-[1px] border-neutral-700 bg-neutral-900 py-1.5 px-2 text-sm text-neutral-500">
        <ul className="flex font-bold  items-center">
        <li>
          <a href="/" rel="nofollow" className="">
          <div className="font-medium text-neutral-300 px-1.5 group relative w-fit transition-transform duration-300 active:scale-95">
          ...
          <li>
          <a href="/contact">
            <div className="font-medium text-neutral-300 px-4 group relative w-fit transition-transform duration-300 active:scale-95">
             <button className="relative z-10 rounded-lg p-0.5 duration-300 group-hover:scale-110">
