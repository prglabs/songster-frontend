...
const Tab = ({ selected, title, setSelected, tabNum }) => {
  return (
    <div className='group relative w-full md:w-fit'>
      ...
      >
        <span
          className={`md:text min-w-[150px] max-w-[270px] rounded text-start text-lg font-semibold tracking-tight transition-colors ${
            selected ? 'text-indigo-500' : 'group-hover:text- text-white'
          }`}
        >
          {title}
        </span>
...
const ArtificialIntelligenceFeature = ({ text }) => (
  ...
  <div className='relative w-full rounded-xl bg-black shadow-xl'>
    <div className='flex w-full rounded-t-xl bg-black p-3'>
      {/* </div> */}
      <div className=''>
        <p className='text-4xl font-bold tracking-tight text-white underline decoration-indigo-500'>
          Artificial Intelligence
        </p>
        <br></br>
        <div className='tracking-0 font-semibold text-white'>
          Our engineers bring subject-matter expertise in artificial
          intelligence and machine learning. We offer solution design,
          implementation, management, and consulting services across various
          domains, including predictive analytics, unsupervised learning, and
          Generative AI.
        </div>
        <br></br>
...
const CostOptimizationFeature = ({ text }) => (
  <div className='w-full'>
    <div className='relative h-[300px] w-full rounded-xl bg-black shadow-xl'>
      <div className='flex w-full gap-1.5 rounded-t-xl bg-black p-3'></div>
      <div className='p-2'>
        <p className='bg-clip-text text-4xl font-bold tracking-tight text-white underline decoration-indigo-500'>
          Cost Optimization
        </p>
        <br></br>
        <div className='font-semibold text-white'>
          Peregrine Labs, founded by former AWS Solutions Architects and Data
          Scientists, assists customers in optimizing their cloud computing
          operations for cost-efficiency and innovation. We achieve this by
          optimizing infrastructure for scalability and guiding customers
          through contract negotiations with cloud providers.
        </div>
        <br></br>
        <GradientShadowButton></GradientShadowButton>
      </div>
  ...
  <div className='w-full'>
    <div className='relative h-[300px] w-full rounded-xl bg-black shadow-xl'>
      ...
      <div className='p-2'>
        ...
        <br></br>
        <div className='font-semibold text-white'>
          We have extensive experience integrating first-party cloud services,
          third-party independent software, and proprietary in-house solutions.
          Our engineers work with customers to modernize applications, migrate
          workloads from on-premise to cloud, and migrate workloads across
  ...
  <div className='w-full'>
    <div className='relative h-[300px] w-full rounded-xl bg-black shadow-xl'>
      ...
      <div className='p-2'>
        ...
        <br></br>
        <div className='font-semibold text-white'>
          Offload the operational complexity of managing cloud infrastructure
          and services to our engineering teams. Peregrine Labs provides managed
          services for individual technologies, platforms, and cloud
          environments, enabling your teams to shift focus from tedious
          infrastructure management to building product differentiation.
        </div>
        <br></br>
        <GradientShadowButton></GradientShadowButton>
      </div>
